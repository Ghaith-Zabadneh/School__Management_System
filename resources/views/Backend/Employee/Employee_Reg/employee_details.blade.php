    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td style="color: #333;">Employee ID</td>
          <td style="color: #333;">{{$data->id_number}}</td>
        </tr>
        <tr>
          <td style="color: #333;">{{ ++$i }}</td>
        ...
        <tr>
          ...
          <td style="color: #333;">{{$data->personalInformation->father_name}}</td>
        </tr>
        <tr>
          <td style="color: #333;">{{ ++$i }}</td>
          <td style="color: #333;">Mother Name</td>
          <td style="color: #333;">{{$data->personalInformation->mother_name}}</td>
        </tr>
        <tr>
          <td style="color: #333;">{{ ++$i }}</td>
          <td style="color: #333;">Mobile Number</td>
          <td style="color: #333;">{{$data->personalInformation->mobile}}</td>
        </tr>
        <tr>
          <td style="color: #333;">{{ ++$i }}</td>
          <td style="color: #333;">Address</td>
          <td style="color: #333;">{{$data->personalInformation->address}}</td>
        </tr>
        <tr>
          <td style="color: #333;">{{ ++$i }}</td>
          <td style="color: #333;">Gender</td>
          <td style="color: #333;">{{$data->personalInformation->gender}}</td>
        </tr>
        <tr>
          <td style="color: #333;">{{ ++$i }}</td>
          <td style="color: #333;">Date Of Birth</td>
          <td style="color: #333;">{{$data->personalInformation->date_of_birth}}</td>
        </tr>
        <tr>
          <td style="color: #333;">{{ ++$i }}</td>
          <td style="color: #333;">Designation</td>
          <td style="color: #333;">{{$data->personalInformation->designation->name}}</td>
        </tr>
        <tr>
            <td style="color: #333;">{{ ++$i }}</td>
            <td style="color: #333;">Salary</td>
            <td style="color: #333;">{{$data->personalInformation->salary}} SP</td>
          </tr>
      </tbody>
    </table>
