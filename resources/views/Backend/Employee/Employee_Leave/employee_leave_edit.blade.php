							...
							<div class="col-md-12">	
                                <div class="row">
                                    <div class="col-md-6">	
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="employee_id" id="employee_id" required="" value="" class="form-control" readonly>
                                                    <option value="" selected="" disabled="">Select Class</option>
                                                    @foreach($employees as $employee)
                                                    @if ($edit_data->employee_id == $employee['id'])
                                ...
                                <div class="col-md-6">	
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="date" name="start_date" id="start_date" value="{{$edit_data->start_date}}" class="form-control"  data-validation-required-message="This field is required" readonly>
                            ...
                            <div class="row">	
                                ...
                                <div class="col-md-6">	
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="date" name="end_date" value="{{$edit_data->end_date}}" class="form-control"  data-validation-required-message="This field is required">
