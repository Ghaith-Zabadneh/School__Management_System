  ...
  <div class="container">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td style="color: #333;">{{ ++$i }}</td>
          <td style="color: #333;">Registration Fee</td>
          <td style="color: #333;">{{$data['registration_fee']->amount}}</td>
        </tr>
        <tr>
            <td style="color: #333;">{{ ++$i }}</td>
        ...
        <tr>
          <td style="color: #333;">{{ ++$i }}</td>
          <td style="color: #333;">Fee For This Student</td>
          <td style="color: #333;">{{$data['registration_fee_with_discount']}}</td>
        </tr>
      </tbody>
    </table>
