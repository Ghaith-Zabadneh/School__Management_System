  ...
  <div class="container">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td style="color: #333;">{{ ++$i }}</td>
          <td style="color: #333;">Monthly Fee</td>
          <td style="color: #333;">{{$data['monthly_fee']->amount}}</td>
        </tr>
        <tr>
            <td style="color: #333;">{{ ++$i }}</td>
        ...
        <tr>
          <td style="color: #333;">{{ ++$i }}</td>
          <td style="color: #333;">Fee For This Student of {{$data['month']}}</td>
          <td style="color: #333;">{{$data['monthly_fee_with_discount']}}</td>
        </tr>
      </tbody>
    </table>
