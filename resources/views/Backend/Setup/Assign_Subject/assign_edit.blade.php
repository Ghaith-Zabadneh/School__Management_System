    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="col">
                ...
                <form method="post" action="{{ route('assign_sub.update',$data['edit_data']['0']->class_id) }}">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="controls">
                                        <select name="class_id" required="" class="form-control">
                                            ...
                                            @foreach($data['classes'] as $class)
                                                <option value="{{ $class->id }}" {{($data['edit_data']['0']->class_id == $class->id) ? "selected" : "" }}>{{ $class->name }}</option>
                                            @endforeach	 
                                        </select>
                                    </div>
                                </div> <!-- // end form group -->
